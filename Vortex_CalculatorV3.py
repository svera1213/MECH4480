...
def vector_vel_T(x_A,y_A,x_vortex,y_vortex,uinf,alpha):
    ...
    for i in range(len(x_vortex)):
        ...
        V_t.append( -1*u_vel(r, y_A, y_vortex[i]) * m.cos(alpha) + v_vel(r, x_A, x_vortex[i]) * m.cos(alpha) )
...
#    V_N.append(kutta_v)
    ...
    V_N.append(vector_vel_T(1.0 , 0.4, x_vortex, y_vortex , uinf, 0))
    
#    print(V_N)
    return V_N

def strength_vortex(x_vortex, y_vortex, x_point, y_point, uinf, alpha_v, vortex_end, vortex_start):
...
#    xend,yend = vortex_end
#    xstart,ystart = vortex_start
#    
#    x_vortex.insert(0,xstart)
#    y_vortex.insert(0,ystart)
#    
#    x_vortex.append(xend)
#    y_vortex.append(yend)
#    print(x_vortex)
#    print(y_vortex)
    ...
    for i in range(len(vortex_s)):
        if i==0:
            v.append(-1*vortex_s[i])
        elif i==(len(vortex_s)-1):
            v.append(-1*vortex_s[i])
