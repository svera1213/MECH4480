...
from Airfoil_profileV4 import test_run
...
#X_v = [0.0, 0.24999999999999994, 0.74999999999999989, 1.0, 0.24999999999999994, 0.74999999999999989]
#Y_v = [0.0, 0.093782499999999963, 0.057593279319048812, -1.6653345369377347e-17,-0.025032499999999992, -0.0048155015412710209] 
##Vortices strengths
#Gamma = [1989.895050240098, 975.06171476261545, 676.53645815987511, 2086.3489549398419, 737.73601348880402, 908.39742003598531
#]
##Constraint points coordinates
#X_c = [0.12499999999999997, 0.49999999999999989, 0.875, 0.12499999999999997, 0.49999999999999989, 0.87499999999999989] 
#Y_c = [0.046891249999999988, 0.075687889659524388, 0.028796639659524399, -0.012516249999999994, -0.014924000770635507, -0.0024077507706355022] 

#Gamma, X_v, Y_v, X_c, Y_c, Gamma2, X2_v, Y2_v, X2_c, Y2_c,dx,dy = test_run()
...
#D1 = Doublet(dx,dy,Gamma[-1],30.0,label='Doublet1')
#D2 = Doublet(dx,-dy,Gamma2[-1],30.0,label='Doublet2')
#V3 = Vortex(dx,dy+0.02,Gamma = Gamma[-1])
#V3 = Vortex(dx,dy-0.02,Gamma = Gamma[-1]*-1)
#S4 = Source(dx,dy,Gamma[-1],label='Source1')
