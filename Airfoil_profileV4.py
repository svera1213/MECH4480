...
# =============================================================================
    ...
    return (X[1:-1],Upper[1:-1]), (X[1:-1],Lower), (Xcons_u,Ycons_u), (Xcons_l[0:-1],Ycons_l[0:-1]), (Xcons_u,Grad_u), (Xcons_l[0:-1],Grad_l[0:-1]) ,(X[0:-1],Upper2[0:-1]), (X[1:-1],Lower2), (Xcons_u2,Ycons_u2), (Xcons_l2[0:-1],Ycons_l2[0:-1]), (Xcons_u2,Grad_u2), (Xcons_l2[0:-1],Grad_l2[0:-1]),du_x,du_y

def test_run():
    
    a, b, c, d, e, f, a2, b2, c2, d2, e2, f2, dx, dy = NACA(4412,52)
    #4412
    x_v1,y_v1 = a
