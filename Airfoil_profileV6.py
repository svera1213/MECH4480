...
from Vortex_CalculatorV2 import strength_vortex
...
#    print('gradient TE=',Grad_u[-1])
#    print('xcons TE=',Xcons_u[-1])
#    print('ycons TE=',Ycons_u[-1])
#    print("gradient upper ",Grad_u)
...
#    dy=
    ...
    return a,b,c,d,e,f,vortex1,vortex2 ,(X[1:-2],Upper2[1:-2]), (X[1:-2],Lower2), (Xcons_u2[0:-1],Ycons_u2[0:-1]), (Xcons_l2[0:-1],Ycons_l2[0:-1]), (Xcons_u2,Grad_u2), (Xcons_l2[0:-1],Grad_l2[0:-2]),du_x,du_y

def test_run():
    
    a, b, c, d, e, f, vortex1, vortex2, a2, b2, c2, d2, e2, f2, dx, dy = NACA("0012",52)
    #4412
    x_v1,y_v1 = a
...
#    return strength_vortex(x_vortex, y_vortex, x_point, y_point, uinf, alpha_v), x_vortex, y_vortex, x_point, y_point#, strength_vortex(x2_vortex, y2_vortex, x2_point, y2_point, uinf, alpha_v2), x2_vortex, y2_vortex, x2_point, y2_point,dx,dy
